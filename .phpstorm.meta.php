...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links.D:\Work\job-search-application\jsa-backend\public\storage' => 'string',
            ...
            'modules.stubs.replacements.vite' => 'string',
            'modules.stubs.replacements.json' => 'string',
            'modules.stubs.replacements.views/index' => 'string',
            'modules.stubs.replacements.views/master' => 'string',
...
'filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links.D:\\Work\\job-search-application\\jsa-backend\\public\\storage','logging.default',
...
'sanctum.csrf-cookie','api.adminmodule.index',
'api.adminmodule.store','api.adminmodule.show','api.adminmodule.update','api.adminmodule.destroy','adminmodule.index',
'adminmodule.create','adminmodule.store','adminmodule.show','adminmodule.edit','adminmodule.update',
'adminmodule.destroy','api.jobmodule.index','api.jobmodule.store','api.jobmodule.show','api.jobmodule.update',
'api.jobmodule.destroy','jobmodule.index','jobmodule.create','jobmodule.store','jobmodule.show',
'jobmodule.edit','jobmodule.update','jobmodule.destroy','api.','api.',
'usermodule.index','usermodule.create','usermodule.store','usermodule.show','usermodule.edit',
'usermodule.update','usermodule.destroy','storage.local',);
        registerArgumentsSet('views', 
'adminmodule::index','adminmodule::layouts.master','jobmodule::index','jobmodule::layouts.master','usermodule::index',
'usermodule::layouts.master','welcome','laravel-exceptions-renderer::components.card','laravel-exceptions-renderer::components.context','laravel-exceptions-renderer::components.editor',
